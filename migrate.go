...
// если schemaForCommon=="", мигрим только глобальные модели (с определенным SchemaName())
// а если schemaForCommon указана, то мигрим только общие модели (без SchemaName()) в указанную схему
