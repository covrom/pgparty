...
FROM &CURRSCHEMA.&Model1=? LEFT JOIN (otherschema.&Model2.Many2ManyField-1) ON :Model1.ID=:Model2.FID	
...
"? LEFT " ""
"JOIN " ""
"(otherschema.&Model2.Many2ManyField-" "otherschema.&Model2.Many2ManyField"
"1)" ""
" ON " ""
":Model1.ID=" ":Model1.ID"
